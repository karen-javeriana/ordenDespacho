...
public class SolicitudCotizacionManual implements Serializable {
    ...
    public SolicitudCotizacionManual(Long id, Long numeroOrden, Long idTipoEnvio, Long idEstadoSolicitud, String direccion, String codigoCiudadOrigen, String ciudadCodigoDestino, Long numeroDocumentoCliente, Date fechaCreacion, Date fechaFinalizacionProveedor, Date fechaFinalizacionCliente, Double peso) {
        this.id = id;
    ...
    public SolicitudCotizacionManual() {
    }
